...
<html lang="en">
	<head>
		...
		<title>Student Login | Q&A Repository</title>
		...
		<nav class="navbar navbar-expand-lg fixed-top navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        <li class="px-2"><a href="Login.html" class="text-white fs-6 fw-light">Login</a></li>
                        <li class="px-2"><a href="Regi.html" class="text-white fs-6">Sign Up</a></li>
                    </ul>
                </div>
			...
			<div class="container">
				<div class="box-wrapper">				
					<div class="box box-border">
						...
						<h4 class="text-center" style="font-family: Noto Sans;">Student</h4><br>
